...
const ProductBenefits = () => (
  <section className="benefits mt-5 pl-0 pl-sm-5">
    ...
    <Row>
      ...
      <Col xs={12} sm={10} md={8}>
        <p className="pb-0">
          Delta waves are the deep sleep waves while alpha waves are the waking
          and reasoning waves. Massage chair therapy helped the adults fall into
          either a deep relaxation state or a light sleeping state while
          decreasing conscious anxiety.
        </p>
      </Col>
    </Row>
  </section>
